#!/bin/bash
# =============================================================================
# baseline.sh - Train transformer encoder only (no CNN)
#
# Usage:
#   ./scripts/train/baseline.sh [--submit] [--holdout_tasks] [--architecture_type TYPE]
#
# Options:
...
if $HOLDOUT_TASKS; then
    OUTPUT_DIR="./results/task_ablation_final/baseline"
else
    OUTPUT_DIR="./results/final/baseline"
fi
LR="6e-4"
EPOCHS="3"
BATCH_SIZE="256"
...
echo "=============================================="
echo "Baseline (Transformer Encoder Only) Training (5 seeds)"
echo "=============================================="
...
# Run baseline (no encoder) training with 5 seeds
for SEED in $SEEDS; do
    run_cmd "Baseline (seed=$SEED)" \
